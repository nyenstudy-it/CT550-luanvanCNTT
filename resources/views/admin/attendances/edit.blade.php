...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light rounded p-4">
        <div class="mb-4">
            <h5 class="mb-1">Chỉnh sửa phân ca làm việc</h5>
            <small class="text-muted">Cập nhật lại ngày, ca và khung giờ dự kiến mà không phải rời khỏi màn hình
                lịch.</small>
        </div>
        ...
        <form method="POST" action="{{ route('admin.attendances.update', $attendance->id) }}">
            @csrf
            @php($submitLabel = 'Cập nhật ca làm')
