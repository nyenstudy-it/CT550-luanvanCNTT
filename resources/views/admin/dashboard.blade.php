        ...
        @else
                ...
                <div class="d-flex flex-wrap gap-2">
                    <form method="GET" action="{{ route('admin.dashboard') }}" class="d-flex gap-2 align-items-center">
                        <input id="month" name="month" type="month" class="form-control form-control-sm"
                            value="{{ $selectedMonth }}" style="width: 150px;">
                        ...
                        <div class="card-body p-4 light-primary text-dark">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-1">{{ number_format($todayRevenue, 0, ',', '.') }} ₫</h5>
                                    <small>
                                        @if(($todayRevenueTrend ?? 0) >= 0)
                                            <span class="badge bg-success">+{{ ($todayRevenueTrend ?? 0) }}%</span>
                                        @else
                                            <span class="badge bg-danger">{{ ($todayRevenueTrend ?? 0) }}%</span>
                                        @endif
                                    </small>
                                </div>
                            </div>
                        ...
                        <div class="card-body p-4 light-info text-dark">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-1">{{ number_format($weekRevenue, 0, ',', '.') }} ₫</h5>
                        ...
                        <div class="card-body p-4 light-success text-dark">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-1">{{ number_format($monthRevenue, 0, ',', '.') }} ₫</h5>
                                    <small>{{ $monthDateRange ?? '' }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4 light-warning text-dark">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <h5 class="mb-1">{{ number_format($returningCustomerRate, 2) }}%</h5>
                                    <small>{{ $newCustomersThisMonth ?? 0 }} khách mới</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-2 mb-4">
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card-stat text-center p-3 rounded border-0 shadow-sm h-100 light-primary text-dark"
                        ...
                        <h6 class="mb-0">{{ $newOrdersThisMonth ?? 0 }}</h6>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card-stat text-center p-3 rounded border-0 shadow-sm h-100 light-danger text-dark"
                        ...
                        <h6 class="mb-0">{{ $newCustomersThisMonth ?? 0 }}</h6>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card-stat text-center p-3 rounded border-0 shadow-sm h-100 light-info text-dark"
                        ...
                        <h6 class="mb-0">{{ $reviewsThisMonth ?? 0 }}</h6>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card-stat text-center p-3 rounded border-0 shadow-sm h-100 light-success text-dark"
                        ...
                        <h6 class="mb-0">{{ $wishlistInteractions ?? 0 }}</h6>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card-stat text-center p-3 rounded border-0 shadow-sm h-100 light-secondary text-dark"
                        ...
                        <h6 class="mb-0">{{ $accountStats['active_accounts'] ?? 0 }}</h6>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        ...
                                        <h5 class="text-success mb-0">{{ number_format($thisWeekRevenue, 0, ',', '.') }} ₫</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Giờ Làm</small>
                                        <h5 class="text-info mb-0">{{ $thisWeekHours }} h</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Chi Phí Nhân Sự</small>
                                        <h5 class="text-danger mb-0">{{ number_format($thisWeekSalary, 0, ',', '.') }} ₫</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Lợi Nhuận</small>
                                        <h5 class="mb-0" style="color: @if($thisWeekProfit >= 0) #28a745 @else #dc3545 @endif">
                                            {{ number_format($thisWeekProfit, 0, ',', '.') }} ₫
                                        </h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header light-success text-dark">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">{{ $monthDateRange }}</small>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Doanh Thu</small>
                                        <h5 class="text-success mb-0">{{ number_format($thisMonthRevenue, 0, ',', '.') }} ₫</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Giờ Làm</small>
                                        <h5 class="text-info mb-0">{{ $thisMonthHours }} h</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Chi Phí Nhân Sự</small>
                                        <h5 class="text-danger mb-0">{{ number_format($thisMonthSalary, 0, ',', '.') }} ₫</h5>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <small class="text-muted d-block mb-1">Lợi Nhuận</small>
                                        <h5 class="mb-0" style="color: @if($thisMonthProfit >= 0) #28a745 @else #dc3545 @endif">
                    ...
                    <div class="bg-light rounded p-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover bg-white small">
                                ...
                                <tbody>
                                    @foreach($weeklyComparison as $index => $week)
                                        <tr @if($index == 3) class="table-info font-weight-bold" @endif>
                                            <td>{{ $week['week'] }} @if($index == 3) <span class="badge bg-info ms-1">Tuần
                                            này</span> @endif</td>
                                            <td class="text-end">{{ $week['shifts'] }}</td>
                                            <td class="text-end">{{ $week['hours'] }}h</td>
                                            <td class="text-end font-weight-bold text-primary">
                                                {{ number_format($week['revenue'], 0, ',', '.') }}đ
                                            </td>
                                            <td class="text-end text-danger">{{ number_format($week['salary'], 0, ',', '.') }}đ</td>
                                            <td class="text-end"
                                                style="color: @if($week['profit'] >= 0) #28a745 @else #dc3545 @endif">
                                                <strong>{{ number_format($week['profit'], 0, ',', '.') }}đ</strong>
                                            </td>
                                            <td class="text-end">
                                                <span
                                                    class="badge @if($week['profit_margin'] >= 0) bg-success @else bg-danger @endif">
                                                    {{ $week['profit_margin'] }}%
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                                    data-bs-target="#profitDetailModal{{ $index }}">
                                                    Xem
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- Modal Chi Tiết Lợi Nhuận -->
                                        <div class="modal fade" id="profitDetailModal{{ $index }}" tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light">
                                                        <h5 class="modal-title">Chi Tiết Lợi Nhuận - Tuần {{ $week['week'] }}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <ul class="list-group list-group-sm">
                                                                        <li
                                                                            ...
                                                                            <strong
                                                                                class="text-success">+{{ number_format($week['revenue'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <ul class="list-group list-group-sm">
                                                                        <li
                                                                            ...
                                                                            <span>Giảm Giá</span>
                                                                            <strong
                                                                                class="text-danger">-{{ number_format($week['discounts'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                        <li
                                                                            class="list-group-item d-flex justify-content-between small">
                                                                            <span>Giá Vốn Hàng Bán (COGS)</span>
                                                                            <strong
                                                                                class="text-danger">-{{ number_format($week['cogs'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                        <li
                                                                            class="list-group-item d-flex justify-content-between small">
                                                                            <span>Chi Phí Vận Chuyển</span>
                                                                            <strong
                                                                                class="text-danger">-{{ number_format($week['shipping_cost'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                        <li
                                                                            class="list-group-item d-flex justify-content-between small">
                                                                            <span>Tiền Nhân Công</span>
                                                                            <strong
                                                                                class="text-danger">-{{ number_format($week['staff_cost'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                        <li
                                                                            class="list-group-item d-flex justify-content-between small">
                                                                            <span>Hao Hụt Hàng Tồn Kho</span>
                                                                            <strong
                                                                                class="text-danger">-{{ number_format($week['inventory_shrinkage'], 0, ',', '.') }}đ</strong>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                        ...
                                                        <ul class="list-group list-group-flush small">
                                                            <li class="list-group-item d-flex justify-content-between">
                                                                ...
                                                                <strong>{{ $week['shifts'] }} ca</strong>
                                                            </li>
                                                            <li class="list-group-item d-flex justify-content-between">
                                                                <span>Tổng giờ làm:</span>
                                                                <strong>{{ $week['hours'] }} giờ</strong>
                                                            </li>
                                                            <li class="list-group-item d-flex justify-content-between">
                                                                <span>Doanh thu trung bình/ca:</span>
                                                                <strong>{{ $week['shifts'] > 0 ? number_format($week['revenue'] / $week['shifts'], 0, ',', '.') : 0 }}đ</strong>
                                                            </li>
                                                            <li class="list-group-item d-flex justify-content-between">
                                                                <span>Chi phí nhân sự/ca:</span>
                                                                <strong>{{ $week['shifts'] > 0 ? number_format($week['staff_cost'] / $week['shifts'], 0, ',', '.') : 0 }}đ</strong>
                                                            </li>
                                                            <li class="list-group-item d-flex justify-content-between">
                                                                <span>Lợi nhuận/ca:</span>
                                                                <strong>{{ $week['shifts'] > 0 ? number_format($week['profit'] / $week['shifts'], 0, ',', '.') : 0 }}đ</strong>
                                                            </li>
                                                        </ul>
                                                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h5 class="modal-title">Chi Tiết Lợi Nhuận - Tuần Này <small
                                    class="text-muted d-block mt-1">{{ $weekDateRange }}</small></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Revenue Breakdown -->
                            <div class="card border-0 bg-light mb-3">
                                <div class="card-body p-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Doanh Thu Bán</span>
                                                <strong
                                                    class="text-success">+{{ number_format($thisWeekProfitDetails['revenue'], 0, ',', '.') }}đ</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Giảm Giá</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisWeekProfitDetails['discounts'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Giá Vốn Hàng Bán (COGS)</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisWeekProfitDetails['cogs'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Chi Phí Vận Chuyển</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisWeekProfitDetails['shipping_cost'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Tiền Nhân Công</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisWeekProfitDetails['staff_cost'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Hao Hụt Hàng Tồn Kho</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisWeekProfitDetails['inventory_shrinkage'], 0, ',', '.') }}đ</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mb-0" style="color: @if($thisWeekProfit >= 0) #28a745 @else #dc3545 @endif">
                                            <strong>{{ number_format($thisWeekProfit, 0, ',', '.') }}đ</strong>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list-group list-group-flush small">
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Số ca làm việc:</span>
                                    <strong>{{ array_key_exists(3, $weeklyComparison) ? $weeklyComparison[3]['shifts'] : 0 }}
                                        ca</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Tổng giờ làm:</span>
                                    <strong>{{ $thisWeekHours }} giờ</strong>
                                </li>
                            </ul>
                        </div>
                        <div class="modal-footer">
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h5 class="modal-title">Chi Tiết Lợi Nhuận - Tháng Này <small
                                    class="text-muted d-block mt-1">{{ $monthDateRange }}</small></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Revenue Breakdown -->
                            <div class="card border-0 bg-light mb-3">
                                <div class="card-body p-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Doanh Thu Bán</span>
                                                <strong
                                                    class="text-success">+{{ number_format($thisMonthProfitDetails['revenue'], 0, ',', '.') }}đ</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <ul class="list-group list-group-sm">
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Giảm Giá</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisMonthProfitDetails['discounts'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Giá Vốn Hàng Bán (COGS)</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisMonthProfitDetails['cogs'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Chi Phí Vận Chuyển</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisMonthProfitDetails['shipping_cost'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Tiền Nhân Công</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisMonthProfitDetails['staff_cost'], 0, ',', '.') }}đ</strong>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between small">
                                                <span>Hao Hụt Hàng Tồn Kho</span>
                                                <strong
                                                    class="text-danger">-{{ number_format($thisMonthProfitDetails['inventory_shrinkage'], 0, ',', '.') }}đ</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <p class="mb-1 small text-muted"><strong>= LỢI NHUẬN THỰC</strong></p>
                                        <h4 class="mb-0" style="color: @if($thisMonthProfit >= 0) #28a745 @else #dc3545 @endif">
                                            <strong>{{ number_format($thisMonthProfit, 0, ',', '.') }}đ</strong>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list-group list-group-flush small">
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Số ca làm việc:</span>
                                    <strong>{{ array_key_exists(11, $monthlyComparison) ? $monthlyComparison[11]['shifts'] : 0 }}
                                        ca</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Tổng giờ làm:</span>
                                    <strong>{{ $thisMonthHours }} giờ</strong>
                                </li>
                            </ul>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal fade" id="statsDetailModal" tabindex="-1">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h5 class="modal-title">Chi Tiết Thống Kê - Tháng {{ $monthLabel ?? '' }}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="p-3 bg-light rounded">
                                                                ...
                                                                <h5 class="text-primary mb-0">
                                                                    {{ number_format($thisMonthRevenue ?? 0, 0, ',', '.') }} ₫
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="p-3 bg-light rounded">
                                                                ...
                                                                <h5 class="mb-0">{{ number_format($monthRevenue, 0, ',', '.') }}
                                                                    ₫</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-primary">{{ $newOrdersThisMonth ?? 0 }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-danger">
                                                                    {{ ($orderStatusSummary['cancelled'] ?? 0) + ($orderStatusSummary['refunded'] ?? 0) }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-primary">{{ $newCustomersThisMonth ?? 0 }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-success">
                                                                    {{ number_format($returningCustomerRate, 2) }}%
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-warning">{{ $reviewsThisMonth ?? 0 }}</h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                <small class="text-muted d-block">Yêu Thích</small>
                                                                <h6 class="mb-0 text-info">{{ $wishlistInteractions ?? 0 }}</h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                <small class="text-muted d-block">Bán Chạy</small>
                                                                <h6 class="mb-0 text-success">{{ count($topProductsMonth) }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-danger">
                                                                    {{ $accountStats['locked_accounts'] ?? 0 }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-warning text-truncate">
                                                                    {{ number_format($writeoffMetrics['total_writeoff_cost_today'] ?? 0, 0, ',', '.') }}
                                                                    ₫
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 col-md-4">
                                                            <div class="p-2 border rounded text-center">
                                                                ...
                                                                <h6 class="mb-0 text-info text-truncate">
                                                                    {{ number_format($writeoffMetrics['total_writeoff_cost_week'] ?? 0, 0, ',', '.') }}
                                                                    ₫
                                                                </h6>
                                                            </div>
                                                        </div>
                ...
                <div class="col-12">
                    <div class="bg-light rounded p-4 h-100">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6 class="mb-0">Phân Tích Khách Hàng Tháng {{ $monthLabel }}</h6>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 light-primary text-dark h-100">
                                    <div class="card-body">
                                        ...
                                        @if($topCustomersByOrders->isNotEmpty())
                                            @foreach($topCustomersByOrders->take(1) as $customer)
                                                <h6 class="mb-1">{{ $customer->customer_name }}</h6>
                                                <small>Số đơn: {{ number_format($customer->orders_count) }} |Tổng chi:
                                                    {{ number_format($customer->total_spent, 0, ',', '.') }}₫</small>
                                            @endforeach
                                        @else
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 light-success text-dark h-100">
                                    <div class="card-body">
                                        ...
                                        @if($topCustomersByValue->isNotEmpty())
                                            @foreach($topCustomersByValue->take(1) as $customer)
                                                <h6 class="mb-1">{{ $customer->customer_name }}</h6>
                                                <small>Tổng chi: {{ number_format($customer->total_spent, 0, ',', '.') }}₫ | Số
                                                    đơn: {{ number_format($customer->orders_count) }}</small>
                                            @endforeach
                                        @else
                                            <small>Chưa có dữ liệu</small>
                                        @endif
            ...
            <div class="modal fade" id="customerDetailModal" tabindex="-1">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h5 class="modal-title">Chi Tiết Phân Tích Khách Hàng - Tháng {{ $monthLabel }}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Tab Navigation -->
                                                ...
                                                @forelse($topCustomersByOrders as $index => $customer)
                                                    <tr>
                                                        ...
                                                        <td class="text-end text-success">
                                                            <strong>{{ number_format($customer->total_spent, 0, ',', '.') }}₫</strong>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                            ...
                                            <tbody>
                                                @forelse($cancellationByCustomer as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <strong>{{ number_format($item->cancelled_count) }}</strong>
                                                        </td>
                                                        <td>
            ...
            <div class="row g-4 mt-1">
                <div class="col-lg-8">
                    <div class="bg-light rounded p-4 h-100">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6 class="mb-0">Sản Phẩm Bán Chạy & Đánh Giá Cao - Tháng {{ $monthLabel }}</h6>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden"
                                        ...
                                        <div class="position-relative bg-light d-flex align-items-center justify-content-center"
                                            ...
                                            @if($product->product_image && file_exists(public_path('storage/' . $product->product_image)))
                                                <img src="{{ asset('storage/' . $product->product_image) }}"
                                                    alt="{{ $product->product_name }}" class="w-100 h-100" style="object-fit: cover;">
                                            @else
                                        ...
                                        <div class="card-body pb-2">
                                            <h6 class="card-title small mb-2 text-truncate" title="{{ $product->product_name }}">
                                                {{ \Illuminate\Support\Str::limit($product->product_name, 40, '...') }}
                                            </h6>
                                            <div class="small text-muted">
                                                <p class="mb-1">Đã bán: <strong
                                                        class="text-dark">{{ number_format($product->sold_qty) }}</strong></p>
                                                <p class="mb-0">Lợi nhuận: <strong
                                                        class="text-success">{{ number_format($product->total_profit, 0, ',', '.') }}₫</strong>
                                                </p>
                                            </div>
                                        </div>
                                        <!-- Footer -->
                                        <div class="card-footer bg-light border-top small">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="badge bg-primary">
                                                    @if(isset($bestSellerTopRatedProducts) && $bestSellerTopRatedProducts->where('product_id', $product->product_id)->first())
                                                        {{ number_format($bestSellerTopRatedProducts->where('product_id', $product->product_id)->first()->avg_rating ?? 0, 1) }}/5
                                                    @else
                                                        N/A
                                                    @endif
                                                </span>
                ...
                <div class="col-lg-6">
                    <div class="bg-light rounded p-4 h-100">
                        ...
                        <p class="mt-3 mb-0">Đánh giá được duyệt tháng này:
                            <strong>{{ number_format((int) max(0, $reviewsThisMonth ?? 0), 0) }}</strong>
                        </p>
                    </div>
                </div>
            </div>
