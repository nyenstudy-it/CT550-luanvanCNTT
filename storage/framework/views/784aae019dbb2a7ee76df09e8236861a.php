    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('admin.blogs.create')); ?>" class="btn btn-sm btn-success">+ Thêm blog</a>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-12 col-sm-4">
                    <div class="border rounded bg-white p-3 h-100">
                        ...
                        <h4 class="mb-0 text-primary"><?php echo e($summary['this_month'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="border rounded bg-white p-3 h-100">
            ...
            <form method="GET" action="<?php echo e(route('admin.blogs.index')); ?>" class="row g-3 mb-4 border rounded bg-white p-3">
                <div class="col-md-5">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('admin.blogs.index')); ?>" class="btn btn-secondary">Đặt lại</a>
                </div>
            </form>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($blog->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $blog->image)); ?>" width="60" height="60" class="rounded"
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mb-1" data-bs-toggle="modal"
                                        data-bs-target="#blogModal<?php echo e($blog->id); ?>">
                                        Chi tiết
                                    </button>
                            ...
                            <!-- Modal Chi tiết -->
                            <div class="modal fade" id="blogModal<?php echo e($blog->id); ?>" tabindex="-1"
                                aria-labelledby="blogModalLabel<?php echo e($blog->id); ?>" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="blogModalLabel<?php echo e($blog->id); ?>">Chi tiết Blog:
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <strong>Slug:</strong> <?php echo e($blog->slug); ?>

                                            </div>
                                            <div class="mb-3">
                                                <strong>Ngày tạo:</strong> <?php echo e($blog->created_at->format('d/m/Y H:i')); ?>

                                            </div>
                                            <div class="mb-3">
                                                <strong>Ảnh chính:</strong><br>
                                                <?php if($blog->image): ?>
                                                    <img src="<?php echo e(asset('storage/' . $blog->image)); ?>" class="img-fluid mb-3">
                                                <?php else: ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <?php $__currentLoopData = $blog->blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="mb-2 border p-2 rounded">
                                                            <span class="badge bg-info mb-1"><?php echo e(ucfirst($block->type)); ?></span>
                                                            ...
                                                            <?php if($block->image): ?>
                                                                <div class="mb-2">
                                                                    <img src="<?php echo e(asset('storage/' . $block->image)); ?>" class="img-fluid">
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
...
<?php echo $__env->make('admin.layouts.layout_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/blogs/index.blade.php ENDPATH**/ ?>