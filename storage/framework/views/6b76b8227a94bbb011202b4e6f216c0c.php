...
<?php if (! $__env->hasRenderedOnce('094b2cec-4f9b-40de-aa5b-bc28566a6622')): $__env->markAsRenderedOnce('094b2cec-4f9b-40de-aa5b-bc28566a6622'); ?>
    <style>
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <?php if($isEdit): ?>
                        <input type="text" class="form-control"
                            value="<?php echo e($attendance->user?->name); ?> - <?php echo e($positionMap[$attendance->staff->position] ?? $attendance->staff->position); ?>"
                            readonly>
                        <input type="hidden" name="staff_id" value="<?php echo e($attendance->staff_id); ?>">
                    <?php else: ?>
                        <select name="staff_id" class="form-select" required>
                            <option value="">-- Chọn nhân viên --</option>
                            <?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($staff->user_id); ?>" <?php echo e(old('staff_id') == $staff->user_id ? 'selected' : ''); ?>>
                                    <?php echo e($staff->user->name); ?>

                                    (<?php echo e($positionMap[$staff->position] ?? $staff->position); ?>)
                                    - <?php echo e($statusMap[$staff->employment_status] ?? $staff->employment_status); ?>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="date" name="work_date"
                        value="<?php echo e(old('work_date', $isEdit ? $attendance->work_date : '')); ?>" class="form-control"
                        required>
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="shift" id="shiftSelect" class="form-select" required>
                        ...
                        <option value="morning" <?php echo e(old('shift', $isEdit ? $attendance->shift : '') == 'morning' ? 'selected' : ''); ?>>
                            Ca sáng
                        </option>
                        <option value="afternoon" <?php echo e(old('shift', $isEdit ? $attendance->shift : '') == 'afternoon' ? 'selected' : ''); ?>>
                            Ca chiều
                        </option>
                    </select>
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="time" name="expected_check_in" id="checkInInput"
                        value="<?php echo e(old('expected_check_in', $isEdit && $attendance->expected_check_in ? \Carbon\Carbon::parse($attendance->expected_check_in)->format('H:i') : '')); ?>"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="time" name="expected_check_out" id="checkOutInput"
                        value="<?php echo e(old('expected_check_out', $isEdit && $attendance->expected_check_out ? \Carbon\Carbon::parse($attendance->expected_check_out)->format('H:i') : '')); ?>"
                        class="form-control" required>
                </div>
            </div>
        </div>
...
<div class="d-flex justify-content-end gap-2 flex-wrap mb-4">
    <a href="<?php echo e(route('admin.attendances.index')); ?>" class="btn btn-secondary">Quay lại</a>
...
<div class="attendance-calendar-wrap">
    ...
    <div id="calendar"></div>
</div><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/attendances/_form.blade.php ENDPATH**/ ?>