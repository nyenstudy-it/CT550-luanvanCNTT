    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('admin.suppliers.create')); ?>" class="btn btn-sm btn-success">+ Thêm nhà phân phối</a>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-12 col-sm-4">
                    <div class="border rounded bg-white p-3 h-100">
                        ...
                        <h4 class="mb-0 text-success"><?php echo e($summary['with_phone'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="border rounded bg-white p-3 h-100">
                        <small class="text-muted d-block mb-1">Có địa chỉ</small>
                        <h4 class="mb-0 text-primary"><?php echo e($summary['with_address'] ?? 0); ?></h4>
                    </div>
                </div>
            </div>

            <form method="GET" action="<?php echo e(route('admin.suppliers.list')); ?>"
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="address" value="<?php echo e(request('address')); ?>" class="form-control"
                        placeholder="Nhập địa chỉ">
                </div>

                <div class="col-md-3 d-flex align-items-end gap-2">
                    <button type="submit" class="btn btn-primary">Lọc</button>
                    <a href="<?php echo e(route('admin.suppliers.list')); ?>" class="btn btn-secondary">Đặt lại</a>
                </div>
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($suppliers->firstItem() + $index); ?></td>
...
<?php echo $__env->make('admin.layouts.layout_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/suppliers/list.blade.php ENDPATH**/ ?>