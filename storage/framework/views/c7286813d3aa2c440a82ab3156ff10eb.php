...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            ...
            <form action="<?php echo e(route('admin.imports.store')); ?>" method="POST" id="importForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.layout_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/imports/create.blade.php ENDPATH**/ ?>