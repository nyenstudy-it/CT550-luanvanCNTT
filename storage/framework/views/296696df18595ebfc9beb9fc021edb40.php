                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="<?php echo e(route('discounts')); ?>">Voucher của tôi</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="voucher-card voucher-card-system <?php echo e($statusClass); ?>">
                            ...
                            <div class="voucher-body">
                                <p class="voucher-value">
                                    <strong>Giảm:</strong> <?php echo e($discount->value_label); ?>

                                </p>
                                <p class="voucher-date">
                                    <strong>Thời hạn:</strong>
                                    <?php if($discount->start_at): ?>
                                        <?php echo e(\Carbon\Carbon::parse($discount->start_at)->format('d/m/Y')); ?> -
                                        <?php echo e($discount->end_at ? \Carbon\Carbon::parse($discount->end_at)->format('d/m/Y') : 'Không thời hạn'); ?>
                                ...
                                <p class="voucher-date mb-0">
                                    ...
                                    <?php if($discount->products->isEmpty()): ?>
                                        Toàn shop
                                    <?php else: ?>
                                        <?php echo e($discount->products->count()); ?> sản phẩm
                                    <?php endif; ?>
                                </p>
                                <p class="voucher-date mb-0">
                            ...
                            <div class="voucher-footer">
                                <?php if(!$used && !$expired): ?>
                                    <a href="<?php echo e(route('pages.home')); ?>?discount=<?php echo e($discount->id); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/pages/my-discounts.blade.php ENDPATH**/ ?>