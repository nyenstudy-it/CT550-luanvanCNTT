    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            ...
            <script>
                ...
                const SERVER_NOW = new Date('<?php echo e($serverNow->toIso8601String()); ?>');
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('staff.staff_attendances')); ?>" class="row g-3 align-items-end">
                        <div class="col-md-3">
            ...
            <div class="row mb-4 g-3">
                <div class="col-lg-4 col-md-6">
                    <div class="bg-white rounded shadow-sm p-4 border-start border-primary border-4">
                        <h6 class="text-muted small mb-2"> Tổng số ca (tháng <?php echo e($currentMonth); ?>/<?php echo e($currentYear); ?>)</h6>
                        <h3 class="fw-bold text-primary mb-0"><?php echo e($totalShifts); ?></h3>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="bg-white rounded shadow-sm p-4 border-start border-info border-4">
                        ...
                        <h3 class="fw-bold text-info mb-0"><?php echo e($totalHours); ?><span class="small ms-1">giờ</span></h3>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="bg-white rounded shadow-sm p-4 border-start border-success border-4">
                        ...
                        <h3 class="fw-bold text-success mb-0"><?php echo e(number_format($totalSalary, 0, ',', '.')); ?><span
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-auto">
                            <small class="text-muted">Lương tháng
                                <?php echo e($monthlySalary->month); ?>/<?php echo e($monthlySalary->year); ?></small><br>
                            <strong class="text-dark">Cơ bản:</strong>
                            <span
                                class="text-primary fw-bold"><?php echo e(number_format($monthlySalary->total_salary, 0, ',', '.')); ?>đ</span>
                        </div>
                        <div class="col-auto">
                            <small class="text-muted">Chấm công</small><br>
                            <small>Đi trễ: <strong><?php echo e($monthlySalary->late_count); ?>x</strong> | Về sớm:
                                <strong><?php echo e($monthlySalary->early_leave_count); ?>x</strong> | Vắng:
                                <strong><?php echo e($monthlySalary->absent_count); ?>x</strong></small>
                        </div>
                        <div class="col-auto">
                            <small class="text-muted">Tính lương</small><br>
                            <small>
                                <span
                                    class="text-danger">-<?php echo e(number_format($monthlySalary->penalty_amount, 0, ',', '.')); ?>đ</span>
                                <span
                                    class="text-success">+<?php echo e(number_format($monthlySalary->bonus_amount, 0, ',', '.')); ?>đ</span>
                            </small>
                        </div>
                        <div class="col-auto ms-auto">
                            <small class="text-muted d-block text-end">Lương cuối cùng</small>
                            <h6 class="text-info fw-bold mb-0"><?php echo e(number_format($monthlySalary->final_salary, 0, ',', '.')); ?>đ
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(\Carbon\Carbon::parse($attendance->work_date)->format('d/m/Y')); ?>
                        ...
                        : '--'); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(!is_null($displaySalary) && $attendance->computed_status === 'completed'): ?>
                                            <strong><?php echo e(number_format($displaySalary, 0, ',', '.')); ?>đ</strong>
                                            <?php if($showComputedDiff): ?>
                                                <div class="small text-muted">(Computed: <?php echo e(number_format($computedSalary, 0, ',', '.')); ?>đ)</div>
                                            <?php endif; ?>
                                        <?php elseif($displaySalary && $attendance->is_completed): ?>
                                            <strong><?php echo e(number_format($displaySalary, 0, ',', '.')); ?>đ</strong>
                                            <?php if($showComputedDiff): ?>
                                                <div class="small text-muted">(Computed: <?php echo e(number_format($computedSalary, 0, ',', '.')); ?>đ)</div>
                                            <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if(!$attendance->check_in): ?>
                                            <form method="POST" action="<?php echo e(route('staff.attendances.check_in', $attendance->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <button type="button" class="btn btn-success btn-sm"
                                                    onclick="handleCheckin('<?php echo e($attendance->id); ?>', '<?php echo e($attendance->work_date); ?>', '<?php echo e($attendance->expected_check_in); ?>')">
                                                    Check in
                                                </button>
                                            </form>

                                        <?php elseif(!$attendance->check_out): ?>
                                            <form method="POST" action="<?php echo e(route('staff.attendances.check_out', $attendance->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="handleCheckout('<?php echo e($attendance->id); ?>', '<?php echo e($attendance->work_date); ?>', '<?php echo e($attendance->expected_check_out); ?>')">
                                                    Check out
                                                </button>
                                            </form>
                                        <?php else: ?>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>
                                                        ...
                                                        <?php if($displayWorkedMinutes !== null): ?>
                                                            <?php echo e(round($displayWorkedMinutes / 60, 2) . ' giờ (' . $displayWorkedMinutes . ' phút)'); ?>

                                                            <?php if(isset($computedWorked) && (int) $computedWorked !== (int) ($attendance->worked_minutes ?? 0)): ?>
                                                                <br><small class="text-muted">(Computed: <?php echo e($computedWorked); ?> phút)</small>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            Chưa tính
                                                        <?php endif; ?>
                                                    ...
                                                    <p>
                                                        ...
                                                        $showSalaryDiff = isset($computedSalary) && (int) $computedSalary !== (int) ($storedSalary ?? 0); ?>
                                                        <?php if($attendance->salary_amount): ?>
                                                                <?php if($attendance->is_early_leave && $attendance->early_leave_status === 'pending'): ?>
                                                                        <!-- Về sớm, chưa duyệt -->
                                                                        <span
                                                                            class="badge bg-warning text-dark"><?php echo e(number_format($displaySalary, 0, ',', '.')); ?>đ</span>
                                                                        <small class="text-muted d-block mt-1">
                                                                            (<?php echo e($rateDisplay); ?>đ/giờ × <?php echo e(round($displayWorkedMinutes / 60, 2)); ?>h)
                                                                        </small>
                                                                    <div class="alert alert-warning mt-2 p-2 mb-0" style="font-size: 0.85rem;">
                                                                        ...
                                                                        <strong><?php echo e(number_format($approvedSalary, 0, ',', '.')); ?>đ</strong>
                                                                        (đến giờ xin về sớm) khi
                                                                        admin duyệt.
                                                                    </div>
                                                                <?php elseif($attendance->is_early_leave && $attendance->early_leave_status === 'approved'): ?>
                                                                <!-- Về sớm, đã duyệt -->
                                                                <span
                                                                    class="badge bg-success"><?php echo e(number_format($attendance->salary_amount, 0, ',', '.')); ?>đ</span>
                                                                <small class="text-muted d-block mt-1">
                                                                    (<?php echo e($rateDisplay); ?>đ/giờ ×
                                                                    <?php echo e(round($approvedWorkedMinutes / 60, 2)); ?>h)
                                                                </small>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <span
                                                                    class="badge bg-success"><?php echo e(number_format($attendance->salary_amount, 0, ',', '.')); ?>đ</span>
                                                                <small class="text-muted d-block mt-1">
                                                                    (<?php echo e($rateDisplay); ?>đ/giờ × <?php echo e(round(($attendance->worked_minutes ?? 0) / 60, 2)); ?>h)
                                                                </small>
                                                                <?php if($showSalaryDiff): ?>
                                                                    <div class="small text-muted mt-1">(Computed:
                                                                        <?php echo e(number_format($computedSalary, 0, ',', '.')); ?>đ)</div>
                                                                <?php endif; ?>
                                                                <?php if($attendance->is_early_leave && $attendance->early_leave_status === 'rejected'): ?>
                                                    ...
                                                    <div class="mb-3">
                                                        <?php if($attendance->is_late || $attendance->is_early_leave): ?>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <?php if($attendance->early_leave_reason): ?>
                                                                        <p class="small mt-1 mb-0"><strong>Lý do:</strong>
                                                                            <?php echo e($attendance->early_leave_reason); ?></p>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                ...
                                                <div class="modal-footer">
                                                    <?php if($attendance->is_early_leave && $attendance->early_leave_status === 'pending' && Auth::user()->role === 'admin'): ?>
                                                        <form method="POST"
                                                        ...
                                                        <form method="POST"
                                                            action="<?php echo e(route('admin.attendances.rejectEarly', $attendance->id)); ?>"
                                                            style="display: inline;">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('admin.layouts.layout_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/attendances/staff_attendances.blade.php ENDPATH**/ ?>