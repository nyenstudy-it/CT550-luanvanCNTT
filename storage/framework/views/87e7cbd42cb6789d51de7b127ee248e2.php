...
<?php $__env->startSection('content'); ?>
        ...
        <section class="checkout spad">
            <div class="container">
                ...
                <form id="checkoutForm" action="<?php echo e(route('checkout.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="order_policy_agree" id="orderPolicyAgreeInput" value="<?php echo e(old('order_policy_agree', '0')); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="receiver_name" class="form-control"
                                            value="<?php echo e(old('receiver_name', auth()->user()->name ?? '')); ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="receiver_phone" class="form-control"
                                            value="<?php echo e(old('receiver_phone', auth()->user()?->customer?->phone ?? '')); ?>"
                                            required>
    ...
    $initialShippingAddress = old('shipping_address', $defaultAddress);
                                    ...
                                    <textarea id="shipping_address" name="shipping_address" class="form-control" rows="3"
                                        required><?php echo e($initialShippingAddress); ?></textarea>

                                    <small id="shipping-address-mode" class="text-muted">
                                        <?php echo e($canUseDefaultAddress && $initialShippingAddress === $defaultAddress ? 'Đang dùng địa chỉ mặc định đã lưu.' : 'Bạn có thể nhập địa chỉ nhận hàng khác với địa chỉ mặc định.'); ?>

                                    </small>

                                    <br>

                                    <a href="<?php echo e(route('customer.profile', ['redirect' => 'checkout'])); ?>" class="text-success">
            ...
            $image = asset('frontend/images/product/product-1.jpg');
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="<?php echo e($image); ?>" alt="<?php echo e($item['name'] ?? 'Sản phẩm'); ?>" width="80"
                                                ...
                                                <td class="text-end">
                                                    <strong><?php echo e(number_format($itemTotal)); ?> đ</strong>
                                                </td>
    ...
    $finalTotal = $total + $shippingFee - $discountAmount;
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        ...
                                        <input class="form-check-input" type="radio" name="payment_method" value="COD" <?php echo e(old('payment_method', 'COD') == 'COD' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="payment_method" value="VNPAY" <?php echo e(old('payment_method') == 'VNPAY' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="payment_method" value="MOMO" <?php echo e(old('payment_method') == 'MOMO' ? 'checked' : ''); ?>>
                    ...
                    <div class="policy-modal-card" role="dialog" aria-modal="true" aria-labelledby="orderPolicyTitle">
                        ...
                        <div class="policy-modal-body">
                            ...
                            <ul class="policy-rules">
                                <?php $__currentLoopData = ($orderPolicyRules ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/pages/checkout.blade.php ENDPATH**/ ?>