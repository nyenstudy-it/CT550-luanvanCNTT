                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.discounts.store')); ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="type" id="discountType" class="form-select" required>
                                    ...
                                    <option value="percent" <?php echo e(old('type') == 'percent' ? 'selected' : ''); ?>>Phần trăm (%)
                                    </option>
                                    <option value="fixed" <?php echo e(old('type') == 'fixed' ? 'selected' : ''); ?>>Tiền cố định</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3" id="maxDiscountWrap" style="display: none;">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="max_discount" class="form-control"
                                    value="<?php echo e(old('max_discount')); ?>" step="0.01" min="0"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="audience" class="form-select" required>
                                    <?php $__currentLoopData = $audienceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audienceValue => $audienceLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($audienceValue); ?>" <?php echo e(old('audience', 'all') === $audienceValue ? 'selected' : ''); ?>>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="scope" id="discountScope" class="form-select" required>
                                    <option value="all" <?php echo e(old('scope', 'all') == 'all' ? 'selected' : ''); ?>>Toàn shop
                                    </option>
                                    <option value="product" <?php echo e(old('scope') == 'product' ? 'selected' : ''); ?>>Theo sản phẩm
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="value" class="form-control" value="<?php echo e(old('value')); ?>"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="usage_limit" class="form-control"
                                    value="<?php echo e(old('usage_limit')); ?>" min="1" placeholder="Không bắt buộc">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="min_order_value" class="form-control"
                                    value="<?php echo e(old('min_order_value', 0)); ?>" min="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="start_at" class="form-control" value="<?php echo e(old('start_at')); ?>">
                            </div>

                            <label class="col-sm-2 col-form-label">Ngày kết thúc</label>
                            <div class="col-sm-4">
                                <input type="date" name="end_at" class="form-control" value="<?php echo e(old('end_at')); ?>">
                            </div>
                        </div>
                        ...
                        <a href="<?php echo e(route('admin.discounts.index')); ?>" class="btn btn-secondary ms-2">
                            Quay lại
                        </a>
...
<?php echo $__env->make('admin.layouts.layout_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/discounts/create.blade.php ENDPATH**/ ?>