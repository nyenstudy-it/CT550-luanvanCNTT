...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/chatbox.css')); ?>" type="text/css">
...
<body>
    ...
    <?php echo $__env->make('pages.components.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldContent('hero'); ?>
    <main>
        <?php echo $__env->yieldContent('content'); ?>
    </main>
    <?php echo $__env->make('pages.components.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        $(document).ready(function () {
            var isHome = <?php echo e(!empty($showCategories) && $showCategories ? 'true' : 'false'); ?>;
    ...
    <script>
        ...
        if (!<?php echo json_encode($flashMessages['showCartPopup']); ?> && localStorage.getItem('showCartPopupOnLoad')) {
            void 0;
        }
        ...
        (function () {
            ...
            const cartUrl = <?php echo json_encode(route('cart.list')); ?>;
            const loginUrl = <?php echo json_encode(route('login')); ?>;
            const orderSuccessBaseUrl = <?php echo json_encode(url('/order')); ?>;
            ...
            <?php if(auth()->user()->role === 'customer'): ?>
                <button id="store-chatbox-toggle" class="ai-chatbox__store-link" type="button" aria-label="Chat với cửa hàng"
                    ...
                    <span id="store-chatbox-badge"
                        class="ai-chatbox__store-badge <?php echo e($storeChatUnreadCount > 0 ? '' : 'd-none'); ?>"><?php echo e($storeChatUnreadCount); ?></span>
                </button>
            <?php endif; ?>
        <?php endif; ?>
    ...
    <script>
        window.chatboxConfig = {
            endpoint: "<?php echo e(route('ai.chatbox')); ?>",
            csrfToken: "<?php echo e(csrf_token()); ?>",
            storeFetchEndpoint: "<?php echo e(auth()->check() && auth()->user()->role === 'customer' ? route('customer.chat') : ''); ?>",
            storeSendEndpoint: "<?php echo e(auth()->check() && auth()->user()->role === 'customer' ? route('customer.chat.send') : ''); ?>",
            storeUnreadEndpoint: "<?php echo e(auth()->check() && auth()->user()->role === 'customer' ? route('customer.chat.unreadCount') : ''); ?>",
            markChatNotificationsEndpoint: "<?php echo e(auth()->check() && auth()->user()->role === 'customer' ? route('customer.notifications.markChatRead') : ''); ?>",
            openStoreChatOnLoad: <?php echo e(request()->boolean('open_store_chat') ? 'true' : 'false'); ?>,
            suggestedQuestions: [
    ...
    <script
        src="<?php echo e(asset('frontend/js/chatbox.js')); ?>?v=<?php echo e(filemtime(public_path('frontend/js/chatbox.js'))); ?>"></script>

    <?php echo $__env->yieldPushContent('scripts'); ?>

</body>

</html><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/layout.blade.php ENDPATH**/ ?>