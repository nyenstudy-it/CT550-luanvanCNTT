...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo e(asset('backend/images/favicon.ico')); ?>" rel="icon">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.authenticate')); ?>">
                            ...
                            <p class="text-center mb-0">Không có tài khoản? <a href="<?php echo e(route('admin.register')); ?>">Đăng
                                    ký</a></p>
                        </form>
...
</html><?php /**PATH C:\xampp\htdocs\luanvan\resources\views/admin/login.blade.php ENDPATH**/ ?>